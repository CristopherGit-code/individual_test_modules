...
#####
SANDBOX_CONFIG_FILE = r"C:\Users\Cristopher Hdz\.oci\config"
...
config = oci.config.from_file(file_location=SANDBOX_CONFIG_FILE,profile_name="API-USER")
...
llm_client = oci.generative_ai_inference.GenerativeAiInferenceClient(
                ...
                timeout=(10,240))
llm_payload =get_chat_detail(get_chat_request(),compartmentId="ocid1.compartment.oc1..aaaaaaaaxj6fuodcmai6n6z5yyqif6a36ewfmmovn42red37ml3wxlehjmga")
